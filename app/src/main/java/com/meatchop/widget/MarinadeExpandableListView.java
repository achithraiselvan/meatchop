 ...
 */
public class MarinadeExpandableListView extends ExpandableListView {

    @SuppressWarnings("unused")
    private static final String TAG = MarinatedExpandableListAdapter.class.getSimpleName();
    ...
    private MarinatedExpandableListAdapter adapter;

    public MarinadeExpandableListView(Context context) {
        super(context);
    }

    public MarinadeExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MarinadeExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        if(adapter instanceof MarinatedExpandableListAdapter) {
            this.adapter = (MarinatedExpandableListAdapter) adapter;
     ...
     */
    public static abstract class MarinatedExpandableListAdapter extends BaseExpandableListAdapter {
        private SparseArray<GroupInfo> groupInfo = new SparseArray<GroupInfo>();
        private MarinadeExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(MarinadeExpandableListView parent) {
            this.parent = parent;
        }
        ...
        private void startExpandAnimation(int groupPosition, int firstChildPosition) {
            Log.d("MarinadExpListView", "startExpandAnimation");
            GroupInfo info = getGroupInfo(groupPosition);
            info.animating = true;
        ...
        private void startCollapseAnimation(int groupPosition, int firstChildPosition) {
            Log.d("MarinadExpListView", "startCollapseAnimation");
            GroupInfo info = getGroupInfo(groupPosition);
            info.animating = true;
            info.firstChildPosition = firstChildPosition;
